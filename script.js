...
function showRodents() {
    document.querySelector("header h3").textContent = "🐹 Гризуни — наші маленькі, кмітливі та зубасті друзі";
...
function showCats() {
    document.querySelector("header h2").textContent = "🐱 Коти — наші пухнасті друзі";
